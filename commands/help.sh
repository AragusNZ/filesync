...
_hcd 'config' 'Show where data lives or change UI preferences' 'show | set progress <hidden|bar|percent>'
...
_hcd 'doctor' 'Inspect mappings/markers or clean ghost non-master markers' '[inspect] | clean'
