...
_hcd 'edit repo (e -r)' 'Update global repos.json only (no project files.json or markers)' '<name> [--rename=] [--path=] [--url=] [--branch=] [--check-sync=] [--mirror-in=] [--merge-using-git=] [--enable] [--disable]'
