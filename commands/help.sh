...
_hcd 'sync (s)' 'Copy from master repos into this project and refresh status' '[--repo=name] [--file=…] [--repo-file=…] [--all-files=…] [-c|--check] [--no-commit] [--dry-run] [-f|--force] [--showall] [--status=a,b,…] [--include-detached] [--move|--mv]'
