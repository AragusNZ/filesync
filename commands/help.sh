...
_hcd 'sync (s)' 'Copy from masters into the project; update files.json' '[--repo=name] [--file=path_fragment | --exact-local=path …] [-c|--check] [--dry-run] [-f|--force] [--showall] [--status=a,b,…] [--include-detached]'
