...
filesync_export_data_paths() {
  ...
  export FILESYNC_COLLECTIONS_FILE="${FILESYNC_DIR}/${FILESYNC_COLLECTIONS_NAME}"
  export FILESYNC_CONFIG_NAME FILESYNC_REPOS_NAME FILESYNC_FILES_NAME FILESYNC_COLLECTIONS_NAME
}
